  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <span
          aria-hidden="true"
          className="absolute right-3 bottom-3 rounded-pill border border-(--color-hairline-strong) bg-(--color-base)/80 px-2 py-1 font-mono text-[10px] uppercase tracking-wider text-(--color-text-2) backdrop-blur"
        >
          {afterLabel}
        </span>
      </div>
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="absolute left-3 bottom-3 rounded-pill border border-(--color-hairline-strong) bg-(--color-base)/80 px-2 py-1 font-mono text-[10px] uppercase tracking-wider text-(--color-text-2) backdrop-blur"
        >
          {beforeLabel}
        </span>
      </div>
